...
holding cell, you realize that youre in the clutches of Professor Booleans 
...
multiplication (*), bit-wise exclusive OR (XOR) and modulo (%) to calculate an 
...
def answer(digest):
	message = []
	for i in range(16):
		message.append(helper(digest[i], message[-1] if i > 0 else 0))
	return message


def helper(digest, prev_m):
	k = 0
	while True:
